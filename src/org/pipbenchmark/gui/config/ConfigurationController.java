...
public class ConfigurationController extends AbstractChildController
    ...
    private void initializeDialogs() {
        ...
        _loadConfigurationDialog.setText("Load Parameters");
        ...
        _saveConfigurationDialog.setText("Save Parameters");
        _saveConfigurationDialog.setFileName("BenchmarkConfiguration.properties");
    }

    private void updateView() {
        _view.setConfiguration(_model.getParameters().getFilteredParameters());
    }
