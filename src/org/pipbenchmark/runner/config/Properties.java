...
public class Properties extends LinkedHashMap<String, String> {
    ...
    public int getAsInteger(String key, int defaultValue) {
        if (this.containsKey(key)) {
            return SimpleTypeConverter.stringToInteger(this.get(key), defaultValue);
        }
        return defaultValue;
    }

    public void setAsInteger(String key, int value) {
        this.put(key, SimpleTypeConverter.integerToString(value));
    }

    public long getAsLong(String key, long defaultValue) {
        if (this.containsKey(key)) {
            return SimpleTypeConverter.stringToLong(this.get(key), defaultValue);
        }
        return defaultValue;
    }

    public void setAsLong(String key, long value) {
        this.put(key, SimpleTypeConverter.longToString(value));
    }

    public double getAsDouble(String key, double defaultValue) {
        if (this.containsKey(key)) {
            return SimpleTypeConverter.stringToDouble(this.get(key), defaultValue);
        }
        return defaultValue;
    }

    public void setAsDouble(String key, double value) {
        this.put(key, SimpleTypeConverter.doubleToString(value));
    }

    public boolean getAsBoolean(String key, boolean defaultValue) {
        if (this.containsKey(key)) {
            return SimpleTypeConverter.stringToBoolean(this.get(key));
        }
        return defaultValue;
    }

    public void setAsBoolean(String key, boolean value) {
        this.put(key, SimpleTypeConverter.booleanToString(value));
    }
